      ...
      <Card className="h-full flex flex-col">
        ...
        <CardContent className="flex-1 overflow-auto space-y-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <Badge
                variant={getSeverityBadgeVariant(selectedViolation.severity)}
              >
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-medium text-foreground">
                  {selectedViolation.regulatorySource.law}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-muted-foreground">Section:</span>
                <span className="font-medium text-foreground">
                  {selectedViolation.regulatorySource.section}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-muted-foreground">Authority:</span>
                <span className="font-medium text-foreground">
                  {selectedViolation.regulatorySource.authority}
                </span>
              </div>
            </div>
      ...
      <Card className="h-full flex flex-col">
        ...
        <CardContent className="flex-1 overflow-auto space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-bold text-2xl text-foreground">
                  {analysisSummary.complianceScore}/100
                </span>
              </div>
              <Progress
                value={analysisSummary.complianceScore}
                className="h-3"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1">
              ...
              <p className="text-lg font-bold text-foreground">
                {analysisSummary.totalViolations}
              </p>
            </div>
            <div className="space-y-1">
              <p className="text-xs text-muted-foreground">Lines Analyzed</p>
              <p className="text-lg font-bold text-foreground">
                {analysisSummary.linesAnalyzed}
              </p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              {Object.entries(analysisSummary.violationsByCategory).map(
                ([category, count]) => (
                  <div
                    key={category}
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              {Object.entries(analysisSummary.violationsByAuthority).map(
                ([authority, count]) => (
                  <div
                    key={authority}
                    className="flex justify-between items-center"
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              {Object.entries(analysisSummary.severityDistribution).map(
                ([severity, count]) => (
                  <div
                    key={severity}
                    className="flex justify-between items-center"
                    ...
                    <div className="flex items-center gap-2">
                      <div
                        className={cn(
                          "w-3 h-3 rounded-sm",
                          severity === "high" &&
                            "bg-[color:var(--color-violation-high)]",
                          severity === "medium" &&
                            "bg-[color:var(--color-violation-medium)]",
                          severity === "low" &&
                            "bg-[color:var(--color-violation-low)]"
                        )}
                      ></div>
          ...
          <div className="pt-4 border-t border-border">
            <div className="flex items-center gap-2 text-xs text-muted-foreground">
              ...
              <span>
                Analyzed on{" "}
                {new Date(analysisSummary.analysisDate).toLocaleString()}
              </span>
            </div>
          </div>
        </CardContent>
        ...
        <div className="text-center space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground max-w-sm">
              Upload a document and run the analysis to see compliance results
