    ...
    return (
      <Card className="h-full flex flex-col">
            ...
            <div className="flex items-center gap-2 flex-1">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Lines {selectedSection.startLine}-{selectedSection.endLine}
                </p>
              </div>
            </div>
            <Badge
        ...
        <CardContent className="flex-1 min-h-0 overflow-auto p-6 space-y-6 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
          ...
          {/* Violation Details */}
          {selectedSection.violationDetails &&
            selectedSection.violationDetails.length > 0 && (
              <div>
                <h3 className="font-semibold text-lg mb-3 flex items-center gap-2">
          ...
          {/* Workarounds */}
          {selectedSection.workarounds &&
            selectedSection.workarounds.length > 0 && (
              <div>
                <h3 className="font-semibold text-lg mb-3 flex items-center gap-2">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-2">
                          <div className="p-3 bg-green-50 border border-green-200 rounded-md">
                            ...
                            <p className="text-xs text-green-700">
                              {workaround.regulatoryAlignment}
                            </p>
                          </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-900">
                    {analysisData.total_sections_analyzed}
                  </p>
                </div>
                  ...
                  <p
                    className={cn(
                      ...
                      getComplianceScoreColor(
                        analysisData.regulatory_summary.compliance_score
                      )
                    )}
                  >
                    Compliance Score
        ...
        >
          ...
          <AlertDescription>
            ...
            {analysisData.regulatory_summary.domains_affected && (
              <span className="ml-2">
                • Affected domains:{" "}
                {analysisData.regulatory_summary.domains_affected.join(", ")}
              </span>
            )}
          </AlertDescription>
        </Alert>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <Badge
                            ...
                            className={cn(
                              "text-xs",
                              getSectionTypeBadgeColor(section.sectionType)
                            )}
                          >
                  ...
                  <CardContent className="pt-0">
                    <div className="flex items-start gap-3 p-3 bg-red-50 border border-red-100 rounded-md">
                      ...
                      <div className="space-y-2">
                        ...
                        {section.violationDetails &&
                          section.violationDetails.length > 0 && (
                            <div className="text-xs text-red-700">
                              <strong>Key violations:</strong>{" "}
                              {section.violationDetails[0].substring(0, 120)}...
                            </div>
                          )}
                      </div>
                    </div>
