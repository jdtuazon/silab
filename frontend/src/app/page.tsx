...
import { Grid, List, Plus, Filter, FolderOpen, Code, TestTube, Rocket, ArchiveX, X } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-6">
          {/* Page header */}
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-neutral-900 mb-1">Products</h1>
            <p className="text-neutral-600">Manage and track all your products</p>
          </div>
          ...
          <div className="mb-6 space-y-4">
            ...
            {filters.selectedTags.length > 0 && (
              <div className="flex flex-wrap gap-2">
                <span className="text-sm text-neutral-600 self-center">Active tags:</span>
