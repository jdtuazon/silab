    ...
    const mockViolations: ViolationData[] = [
      {
        ...
        endChar: 312,
        severity: "high",
        violatedText: "customer data will be shared with third-party marketing partners",
        regulatorySource: {
          law: "RA 10173",
          section: "Section 12",
          document: "Data Privacy Act of 2012",
          authority: "NPC",
          directQuote: "Personal data shall not be processed without the consent of the data subject",
        },
        explanation:
        ...
        workarounds: [
          {
            ...
            steps: ["Add consent checkbox", "Provide clear disclosure", "Allow opt-out"],
      ...
      },
      {
        ...
        endChar: 634,
        severity: "medium",
        violatedText: "transactions above PHP 500,000 require additional verification",
        regulatorySource: {
          law: "BSP Circular 950",
          section: "Section 4.2",
          document: "Anti-Money Laundering Guidelines",
          authority: "BSP",
          directQuote: "Covered transactions exceeding PHP 500,000 must be reported within 5 banking days",
        },
        explanation: "The threshold is correct but missing the mandatory reporting requirement.",
        workarounds: [
          {
